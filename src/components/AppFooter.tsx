        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/search" className="text-gray-600 hover:text-indigo-600 transition-colors">
                  搜索
                </Link>
              </li>
              <li>
                <Link to="/ranking" className="text-gray-600 hover:text-indigo-600 transition-colors">
                  排行榜
                </Link>
              </li>
            </ul>
